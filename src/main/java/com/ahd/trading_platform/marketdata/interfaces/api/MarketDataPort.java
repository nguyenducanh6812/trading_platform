 ...
 * Provides access to historical market data and instrument information for other modules.
 *
...
public interface MarketDataPort {
    ...
    /**
     * Retrieves instrument information by symbol.
     *
     * @param symbol The instrument symbol (e.g., "BTC", "ETH")
     * @return Optional containing instrument info if found, empty otherwise
     */
    Optional<InstrumentInfoDto> getInstrumentInfo(String symbol);
