...
/**
 * JPA Entity for LINEAR market price data storage.
 * Supports all trading symbols in the LINEAR market (e.g., BTCUSDT, ETHUSDT).
 */
@Entity
@Table(
    name = "linear_price_data",
    schema = "trading_platform",
    uniqueConstraints = @UniqueConstraint(name = "uk_linear_price_symbol_timestamp", columnNames = {"symbol", "timestamp"}),
    indexes = {
        @Index(name = "idx_linear_price_symbol", columnList = "symbol"),
        @Index(name = "idx_linear_price_timestamp", columnList = "timestamp"),
        @Index(name = "idx_linear_price_symbol_timestamp", columnList = "symbol, timestamp")
    }
)
...
@NoArgsConstructor
@AllArgsConstructor
public class LinearPriceDataEntity {
    ...
    public boolean equals(Object obj) {
        ...
        LinearPriceDataEntity that = (LinearPriceDataEntity) obj;
