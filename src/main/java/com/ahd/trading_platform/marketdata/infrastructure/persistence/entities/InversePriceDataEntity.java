...
/**
 * JPA Entity for INVERSE market price data storage.
 */
@Entity
@Table(
    name = "inverse_price_data",
    schema = "trading_platform",
    uniqueConstraints = @UniqueConstraint(name = "uk_inverse_price_symbol_timestamp", columnNames = {"symbol", "timestamp"}),
    indexes = {
        @Index(name = "idx_inverse_price_symbol", columnList = "symbol"),
        @Index(name = "idx_inverse_price_timestamp", columnList = "timestamp"),
        @Index(name = "idx_inverse_price_symbol_timestamp", columnList = "symbol, timestamp")
    }
)
...
@NoArgsConstructor
@AllArgsConstructor
public class InversePriceDataEntity {
    ...
    public boolean equals(Object obj) {
        ...
        InversePriceDataEntity that = (InversePriceDataEntity) obj;
