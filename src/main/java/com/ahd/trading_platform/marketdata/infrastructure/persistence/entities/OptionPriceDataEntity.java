...
/**
 * JPA Entity for OPTION market price data storage.
 */
@Entity
@Table(
    name = "option_price_data",
    schema = "trading_platform",
    uniqueConstraints = @UniqueConstraint(name = "uk_option_price_symbol_timestamp", columnNames = {"symbol", "timestamp"}),
    indexes = {
        @Index(name = "idx_option_price_symbol", columnList = "symbol"),
        @Index(name = "idx_option_price_timestamp", columnList = "timestamp"),
        @Index(name = "idx_option_price_symbol_timestamp", columnList = "symbol, timestamp")
    }
)
...
@NoArgsConstructor
@AllArgsConstructor
public class OptionPriceDataEntity {
    ...
    public boolean equals(Object obj) {
        ...
        OptionPriceDataEntity that = (OptionPriceDataEntity) obj;
