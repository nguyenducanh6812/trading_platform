...
/**
 * JPA entity for LINEAR market expected return predictions.
 * Stores ARIMA forecast results with model version tracking.
 */
@Entity
@Table(name = "linear_expected_return_prediction",
       schema = "trading_platform",
       indexes = {
           @Index(name = "idx_linear_prediction_symbol", columnList = "symbol"),
           @Index(name = "idx_linear_prediction_forecast_date", columnList = "forecast_date"),
           @Index(name = "idx_linear_prediction_model_version", columnList = "model_version"),
           @Index(name = "idx_linear_prediction_execution_id", columnList = "execution_id"),
           @Index(name = "idx_linear_prediction_created", columnList = "created_at")
       },
       uniqueConstraints = {
           @UniqueConstraint(name = "uk_linear_prediction_symbol_date_model",
                           columnNames = {"symbol", "forecast_date", "model_version"})
       })
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LinearExpectedReturnPredictionEntity {
