...
@Entity
@Table(name = "option_demean_diff_oc_master_data",
       schema = "trading_platform",
       uniqueConstraints = @UniqueConstraint(name = "uk_option_demean_symbol_timestamp", columnNames = {"symbol", "timestamp"}),
       indexes = {
           @Index(name = "idx_option_demean_symbol", columnList = "symbol"),
           @Index(name = "idx_option_demean_timestamp", columnList = "timestamp"),
           @Index(name = "idx_option_demean_symbol_timestamp", columnList = "symbol, timestamp")
       })
...
@AllArgsConstructor
@Builder
public class OptionDemeanDiffOCMasterDataEntity {
