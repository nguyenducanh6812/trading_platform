...
/**
 * Entity for storing BTC-specific Demean_Diff_OC master data.
 * Follows the same pattern as BtcPriceEntity for instrument-specific table separation.
 */
@Entity
@Table(name = "btc_demean_diff_oc_master_data", indexes = {
    @Index(name = "idx_btc_demean_timestamp", columnList = "timestamp"),
    @Index(name = "idx_btc_demean_date_range", columnList = "timestamp")
})
...
@AllArgsConstructor
@Builder
public class BtcDemeanDiffOCMasterDataEntity {
